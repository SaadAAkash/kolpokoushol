...
export const footerData = {
  ...
  //   By <a class="text-teal-900 hover:underline dark:text-gray-200" href="https://onwidget.com/"> onWidget</a> · All rights reserved.
  // `,
  footNote: `
    By <a class="text-teal-900 hover:underline dark:text-gray-200" href="https://universalmachine.io/"> Universal Machine Inc.</a> · All rights reserved.
  `,
};
